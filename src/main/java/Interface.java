...
public class Interface {
    ...
    public Interface(Vm vm,ProcessadorMacros processadorMacros,NewAssembler assembler,Linker linker) {
        ...
        memoryPanel.setBorder(BorderFactory.createTitledBorder("Memoria"));
        ...
        runButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(mode == 2){
                    executeRun(arquivo2Field.getText());

                }
                if(mode == 1){
                    executeRun(arquivo1Field.getText());
    ...
    public void updateInterface() {
        ...
        for (int i = 0; i < 100; i++) {  
            memoryContent.append("Memoria[").append(i).append("] = ")
    ...
    public void executeStep(String path1, String path2){
        switch(contadorStep){
            ...
            case 3:
                ...
                break;
            case 4:
                assembler.assemble("MASMAPRG2.asm","program2.obj","program2.lst", "usefulTable2.txt");
                contadorStep++;
                statusOpField.setText("segundo arquivo montado!");
                break;
            case 5:
                linker.link2("program.obj","program2.obj", "usefulTable.txt", "usefulTable2.txt");
                contadorStep++;
                statusOpField.setText("arquivos linkados!");
                break;
            case 6:
                vm.loadProgramFromFile("output.hpx");
                contadorStep++;
    ...
    public void executeRun(String path1,String path2) throws IOException{
            processadorMacros.runProcessador(path1,verifica);
            verifica = true;
            processadorMacros.runProcessador(path2,verifica);
            assembler.assemble("MASMAPRG.asm","program.obj","program.lst", "usefulTable.txt");
    ...
    public void executeRun(String path1){
        processadorMacros.runProcessador(path1,verifica);
        assembler.assemble("MASMAPRG.asm","program.obj","program.lst", "usefulTable.txt");
        linker.link("program.obj","usufulTable.txt");
        vm.loadProgramFromFile("output.hpx");
        while(vm.executeInstruction());
        statusOpField.setText("rodando da VM!");
